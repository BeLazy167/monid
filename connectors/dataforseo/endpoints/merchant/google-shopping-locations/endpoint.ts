...
/**
 * Google Shopping Locations — `GET /v3/merchant/google/locations/{country}`
 * (v1 `/google-shopping/locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Shopping Locations",
        summary:
            "Look up Google Shopping location codes and names by country " +
            "and text.",
        description:
            ...
            "/google-shopping/products, call " +
            "dataforseo#google-shopping/products (the endpoint this list " +
            "is for). To use these values in /google-shopping/sellers, " +
            "call dataforseo#google-shopping/sellers (the endpoint this " +
            "list is for). To use these values in " +
            "/google-shopping/product-info, call " +
            "dataforseo#google-shopping/product-info (the endpoint this " +
            "list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/merchant/google/locations/{country}/",
        categories: ["google-shopping"],
    },
    endpoint: "/google-shopping/locations",
    request: { method: "GET", path: "/v3/merchant/google/locations/{country}" },
    input: {
