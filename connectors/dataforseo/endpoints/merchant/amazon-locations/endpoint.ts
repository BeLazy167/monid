...
/**
 * Amazon Locations — `GET /v3/merchant/amazon/locations/{country}` (v1
 * `/amazon/locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Amazon Locations",
        summary: "Look up Amazon marketplace location codes and names by " +
            "country and text.",
        description:
            ...
            "/amazon/products, call dataforseo#amazon/products (the " +
            "endpoint this list is for). To use these values in " +
            "/amazon/asin, call dataforseo#amazon/asin (the endpoint this " +
            "list is for). To use these values in /amazon/sellers, call " +
            "dataforseo#amazon/sellers (the endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/merchant/amazon/locations/{country}/",
        categories: ["amazon"],
    },
    endpoint: "/amazon/locations",
    request: { method: "GET", path: "/v3/merchant/amazon/locations/{country}" },
    input: {
