...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "platform, location, language, and filters. Suited for AI " +
            "visibility scorecards. To see which fields filters and " +
            "order_by accept here, call dataforseo#ai/mentions-filters " +
            "(free lookup of filterable fields). To find supported " +
            "location and language pairs, call " +
