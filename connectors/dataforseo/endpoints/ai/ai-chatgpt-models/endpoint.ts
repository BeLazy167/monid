...
/**
 * ChatGPT Models — `GET /v3/ai_optimization/chat_gpt/llm_responses/models`
 * (v1 `/ai/chatgpt-models`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "ChatGPT Models",
        summary: "List the ChatGPT model names chatgpt-response accepts.",
        description:
            "Free lookup. Returns rows of model_name with each model's " +
            "web_search support. Search matches the name. To use these " +
            "values in /ai/chatgpt-response, call " +
            "dataforseo#ai/chatgpt-response (the endpoint this list is " +
            "for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/models/",
        categories: ["geo"],
    },
    endpoint: "/ai/chatgpt-models",
    request: {
        method: "GET",
