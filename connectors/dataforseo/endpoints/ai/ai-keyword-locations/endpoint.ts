...
/**
 * AI Keyword Locations — `GET
 * /v3/ai_optimization/ai_keyword_data/locations_and_languages` (v1
 * `/ai/keyword-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "AI Keyword Locations",
        summary: "Look up the country and language pairs " +
            "ai-keyword-search-volume supports.",
        description:
            ...
            "/ai/keyword-search-volume, call " +
            "dataforseo#ai/keyword-search-volume (the endpoint this list " +
            "is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/ai_optimization/ai_keyword_data/locations_and_languages/",
        categories: ["geo"],
    },
    endpoint: "/ai/keyword-locations",
    request: {
        method: "GET",
