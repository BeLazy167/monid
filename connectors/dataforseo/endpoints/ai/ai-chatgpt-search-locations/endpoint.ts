...
/**
 * ChatGPT Search Locations — `GET
 * /v3/ai_optimization/chat_gpt/llm_scraper/locations/{country}` (v1
 * `/ai/chatgpt-search-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "ChatGPT Search Locations",
        summary:
            "Look up location codes and names for ChatGPT search answers " +
            "by country and text.",
        description:
            ...
            "/ai/chatgpt-search, call dataforseo#ai/chatgpt-search (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_scraper/locations/{country}/",
        categories: ["ai-search"],
    },
    endpoint: "/ai/chatgpt-search-locations",
    request: {
        method: "GET",
