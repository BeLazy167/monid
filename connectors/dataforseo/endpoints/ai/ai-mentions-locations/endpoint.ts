...
/**
 * AI Mentions Locations — `GET
 * /v3/ai_optimization/llm_mentions/locations_and_languages` (v1
 * `/ai/mentions-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "AI Mentions Locations",
        summary: "Look up the country and language pairs the AI mentions " +
            "endpoints support.",
        description:
            ...
            "/ai/mentions-target-metrics, call " +
            "dataforseo#ai/mentions-target-metrics (the endpoint this " +
    ...
    endpoint: "/ai/mentions-locations",
    request: {
        method: "GET",
