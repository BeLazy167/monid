...
/**
 * YouTube Locations — `GET /v3/serp/youtube/locations/{country}` (v1
 * `/serp/youtube-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "YouTube Locations",
        summary: "Look up YouTube search location codes and names by country " +
            "and text.",
        description:
            ...
            "/serp/youtube-organic, call dataforseo#serp/youtube-organic " +
            "(the endpoint this list is for). To use these values in " +
            "/serp/youtube-comments, call " +
            "dataforseo#serp/youtube-comments (the endpoint this list is " +
            "for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/serp/youtube/locations/{country}/",
        categories: ["video-search"],
    },
    endpoint: "/serp/youtube-locations",
    request: { method: "GET", path: "/v3/serp/youtube/locations/{country}" },
    input: {
