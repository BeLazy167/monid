...
/**
 * Yahoo Locations — `GET /v3/serp/yahoo/locations/{country}` (v1
 * `/serp/yahoo-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Yahoo Locations",
        summary:
            "Look up Yahoo search location codes and names by country and " +
            "text.",
        description:
            ...
            "/serp/yahoo-organic, call dataforseo#serp/yahoo-organic (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/serp/yahoo/locations/{country}/",
        categories: ["web-search"],
    },
    endpoint: "/serp/yahoo-locations",
    request: { method: "GET", path: "/v3/serp/yahoo/locations/{country}" },
    input: {
