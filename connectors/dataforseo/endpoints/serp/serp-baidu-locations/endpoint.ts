...
/**
 * Baidu Locations — `GET /v3/serp/baidu/locations/{country}` (v1
 * `/serp/baidu-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Baidu Locations",
        summary:
            "Look up Baidu search location codes and names by country and " +
            "text.",
        description:
            ...
            "/serp/baidu-organic, call dataforseo#serp/baidu-organic (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/serp/baidu/locations/{country}/",
        categories: ["web-search"],
    },
    endpoint: "/serp/baidu-locations",
    request: { method: "GET", path: "/v3/serp/baidu/locations/{country}" },
    input: {
