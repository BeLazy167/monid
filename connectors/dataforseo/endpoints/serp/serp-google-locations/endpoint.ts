...
/**
 * Google Locations — `GET /v3/serp/google/locations/{country}` (v1
 * `/serp/google-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Locations",
        summary: "Look up Google search location codes and names by country " +
            "and text.",
        description:
            ...
            "/serp/google-organic, call dataforseo#serp/google-organic " +
            "(the endpoint this list is for). To use these values in " +
            "/serp/google-maps, call dataforseo#serp/google-maps (the " +
            "endpoint this list is for). To use these values in " +
            "/serp/google-news, call dataforseo#serp/google-news (the " +
    ...
    request: { method: "GET", path: "/v3/serp/google/locations/{country}" },
    input: {
