...
/**
 * Seznam Locations — `GET /v3/serp/seznam/locations/{country}` (v1
 * `/serp/seznam-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Seznam Locations",
        summary: "Look up Seznam search location codes and names by country " +
            "and text.",
        description:
            ...
            "/serp/seznam-organic, call dataforseo#serp/seznam-organic " +
            "(the endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/serp/seznam/locations/{country}/",
        categories: ["web-search"],
    },
    endpoint: "/serp/seznam-locations",
    request: { method: "GET", path: "/v3/serp/seznam/locations/{country}" },
    input: {
