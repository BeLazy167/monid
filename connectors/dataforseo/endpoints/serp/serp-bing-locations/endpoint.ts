...
/**
 * Bing Locations — `GET /v3/serp/bing/locations/{country}` (v1
 * `/serp/bing-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Bing Locations",
        summary:
            "Look up Bing search location codes and names by country and " +
            "text.",
        description:
            ...
            "/serp/bing-organic, call dataforseo#serp/bing-organic (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/serp/bing/locations/{country}/",
        categories: ["web-search"],
    },
    endpoint: "/serp/bing-locations",
    request: { method: "GET", path: "/v3/serp/bing/locations/{country}" },
    input: {
