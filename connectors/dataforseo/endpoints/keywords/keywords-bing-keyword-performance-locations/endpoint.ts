...
/**
 * Bing Performance Locations — `GET
 * /v3/keywords_data/bing/keyword_performance/locations_and_languages` (v1
 * `/keywords/bing-keyword-performance-locations`). Free dictionary lookup
 * (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Bing Performance Locations",
        summary: "Look up the country and language pairs " +
            "bing-keyword-performance supports.",
        description:
            ...
            "/keywords/bing-keyword-performance, call " +
            "dataforseo#keywords/bing-keyword-performance (the endpoint " +
            "this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/bing/keyword_performance/locations_and_languages/",
        categories: ["seo"],
    },
    endpoint: "/keywords/bing-keyword-performance-locations",
    request: {
        method: "GET",
        path:
