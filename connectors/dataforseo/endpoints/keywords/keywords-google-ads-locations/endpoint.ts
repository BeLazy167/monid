...
/**
 * Google Ads Locations — `GET
 * /v3/keywords_data/google_ads/locations/{country}` (v1
 * `/keywords/google-ads-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Ads Locations",
        summary: "Look up Google Ads location codes and names by country and " +
            "text.",
        description:
            ...
            "/keywords/google-ads-search-volume, call " +
            "dataforseo#keywords/google-ads-search-volume (the endpoint " +
            "this list is for). To use these values in " +
            "/keywords/google-ads-keywords-for-site, call " +
            "dataforseo#keywords/google-ads-keywords-for-site (the " +
            "endpoint this list is for). To use these values in " +
            "/keywords/google-ads-keywords-for-keywords, call " +
            "dataforseo#keywords/google-ads-keywords-for-keywords (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/google_ads/locations/{country}/",
        categories: ["seo"],
    },
    endpoint: "/keywords/google-ads-locations",
    request: {
        method: "GET",
