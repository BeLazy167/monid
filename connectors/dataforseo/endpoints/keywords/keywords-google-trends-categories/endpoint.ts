...
/**
 * Google Trends Categories — `GET
 * /v3/keywords_data/google_trends/categories` (v1
 * `/keywords/google-trends-categories`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Trends Categories",
        summary: "Look up Google Trends category codes by name.",
        description:
            "Free lookup. Returns rows of category_code, category_name, " +
            "and category_code_parent. Search matches the category name. " +
            "To use these values in /keywords/google-trends-explore, call " +
            "dataforseo#keywords/google-trends-explore (the endpoint this " +
            "list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/google_trends/categories/",
        categories: ["seo"],
    },
    endpoint: "/keywords/google-trends-categories",
    request: {
        method: "GET",
