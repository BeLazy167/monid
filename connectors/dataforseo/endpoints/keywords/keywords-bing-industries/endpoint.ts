...
/**
 * Bing Industries — `GET
 * /v3/keywords_data/bing/audience_estimation/industries` (v1
 * `/keywords/bing-industries`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Bing Industries",
        summary: "Look up industry ids for Microsoft Ads audience estimation.",
        description:
            "Free lookup. Returns rows of industry_id and name. Search " +
            "matches the name. To use these values in " +
            "/keywords/bing-audience-estimation, call " +
            "dataforseo#keywords/bing-audience-estimation (the endpoint " +
            "this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/bing/audience_estimation/industries/",
        categories: ["seo"],
    },
    endpoint: "/keywords/bing-industries",
    request: {
        method: "GET",
