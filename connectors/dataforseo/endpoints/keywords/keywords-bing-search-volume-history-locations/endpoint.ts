...
/**
 * Bing History Locations — `GET
 * /v3/keywords_data/bing/search_volume_history/locations_and_languages` (v1
 * `/keywords/bing-search-volume-history-locations`). Free dictionary lookup
 * (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Bing History Locations",
        summary: "Look up the country and language pairs " +
            "bing-search-volume-history supports.",
        description:
            ...
            "/keywords/bing-search-volume-history, call " +
            "dataforseo#keywords/bing-search-volume-history (the endpoint " +
            "this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/bing/search_volume_history/locations_and_languages/",
        categories: ["seo"],
    },
    endpoint: "/keywords/bing-search-volume-history-locations",
    request: {
        method: "GET",
        path:
