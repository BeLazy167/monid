...
/**
 * Bing Job Functions — `GET
 * /v3/keywords_data/bing/audience_estimation/job_functions` (v1
 * `/keywords/bing-job-functions`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Bing Job Functions",
        summary: "Look up job function ids for Microsoft Ads audience " +
            "estimation.",
        description: "Free lookup. Returns rows of job_function_id and name. " +
            "Search matches the name. To use these values in " +
            "/keywords/bing-audience-estimation, call " +
            "dataforseo#keywords/bing-audience-estimation (the endpoint " +
            "this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/bing/audience_estimation/job_functions/",
        categories: ["seo"],
    },
    endpoint: "/keywords/bing-job-functions",
    request: {
        method: "GET",
