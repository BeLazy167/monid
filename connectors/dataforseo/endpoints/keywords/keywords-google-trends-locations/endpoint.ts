...
/**
 * Google Trends Locations — `GET
 * /v3/keywords_data/google_trends/locations/{country}` (v1
 * `/keywords/google-trends-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Trends Locations",
        summary: "Look up Google Trends location codes and names by country " +
            "and text.",
        description:
            ...
            "/keywords/google-trends-explore, call " +
            "dataforseo#keywords/google-trends-explore (the endpoint this " +
            "list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/google_trends/locations/{country}/",
        categories: ["seo"],
    },
    endpoint: "/keywords/google-trends-locations",
    request: {
        method: "GET",
