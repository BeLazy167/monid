...
/**
 * Clickstream Locations — `GET
 * /v3/keywords_data/clickstream_data/locations_and_languages` (v1
 * `/keywords/clickstream-locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Clickstream Locations",
        summary: "Look up the country and language pairs the clickstream " +
            "volume endpoints support.",
        description:
            "Free lookup. Returns rows of location_code, location_name, " +
            "country_iso_code, and available_languages. Search matches " +
            "the country name. To use these values in " +
            "/keywords/clickstream-search-volume, call " +
            "dataforseo#keywords/clickstream-search-volume (the endpoint " +
            "this list is for). To use these values in " +
            "/keywords/clickstream-bulk-search-volume, call " +
            "dataforseo#keywords/clickstream-bulk-search-volume (the " +
            "endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/keywords_data/clickstream_data/locations_and_languages/",
        categories: ["seo"],
    },
    endpoint: "/keywords/clickstream-locations",
    request: {
        method: "GET",
