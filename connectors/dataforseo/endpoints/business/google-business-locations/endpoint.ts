...
/**
 * Google Business Locations — `GET
 * /v3/business_data/google/locations/{country}` (v1
 * `/google-business/locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Business Locations",
        summary:
            "Look up Google Business location codes and names by country " +
            "and text.",
        description:
            ...
            "/google-business/info, call dataforseo#google-business/info " +
            "(the endpoint this list is for). To use these values in " +
            "/google-business/reviews, call " +
            "dataforseo#google-business/reviews (the endpoint this list " +
            "is for). To use these values in /google-hotels/search, call " +
            "dataforseo#google-hotels/search (the endpoint this list is " +
            "for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/business_data/google/locations/{country}/",
        categories: ["maps"],
    },
    endpoint: "/google-business/locations",
    request: {
        method: "GET",
