...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "categories, coordinate radius). Supports filters and up to " +
            "1000 rows. Suited for market sizing by business type. To " +
            "find business category names, call " +
            "dataforseo#business/categories (free lookup, search by " +
            "name). To see which fields filters and order_by accept here, " +
            "call dataforseo#business/listing-filters (free lookup of " +
            "filterable fields).",
        docsUrl:
