 ...
 * (v1 `/google-hotels/search`). Page-billed: $0.004 per page of 20 results;
...
export default defineEndpoint({
    meta: {
        ...
        categories: ["hotels"],
        notes: [
            "Billed per page of about 20 hotels.",
        ],
    },
    ...
    input: {
        schema: {
            body: zGoogleHotelsSearchBody.extend({
                depth: zGoogleHotelsSearchBody.shape.depth.unwrap().default(20),
            }),
        },
    },
    usage: {
