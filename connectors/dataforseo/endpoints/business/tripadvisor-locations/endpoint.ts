...
/**
 * Tripadvisor Locations — `GET
 * /v3/business_data/tripadvisor/locations/{country}` (v1
 * `/tripadvisor/locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Tripadvisor Locations",
        summary:
            "Look up Tripadvisor location codes and names by country and " +
            "text.",
        description:
            ...
            "/tripadvisor/search, call dataforseo#tripadvisor/search (the " +
            "endpoint this list is for). To use these values in " +
            "/tripadvisor/reviews, call dataforseo#tripadvisor/reviews " +
            "(the endpoint this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/business_data/tripadvisor/locations/{country}/",
        categories: ["hotels"],
    },
    endpoint: "/tripadvisor/locations",
    request: {
        method: "GET",
