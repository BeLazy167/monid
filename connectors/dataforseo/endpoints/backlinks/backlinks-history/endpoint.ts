...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "link-growth charts. To see which fields filters and order_by " +
            "accept here, call dataforseo#backlinks/filters (free lookup " +
            "of filterable fields per Backlinks endpoint).",
