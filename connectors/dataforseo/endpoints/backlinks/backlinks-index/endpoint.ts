...
export default defineEndpoint({
    meta: {
        ...
        description: "Free lookup. Returns the number of backlinks, pages, " +
            "domains, and IPs in the live backlink index and when it was " +
            "last updated. To use these values in /backlinks/summary, " +
            "call dataforseo#backlinks/summary (the endpoint this list is " +
            "for).",
