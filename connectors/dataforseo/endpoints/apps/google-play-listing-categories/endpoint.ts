...
/**
 * Google Play Listing Categories — `GET
 * /v3/app_data/google/app_listings/categories` (v1
 * `/google-play/listing-categories`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Play Listing Categories",
        summary:
            "Look up the category ids the Google Play app database search " +
            "accepts.",
        description: "Free lookup. Returns the category ids and names for " +
            "google-play-listings. Search matches the name. To use these " +
            "values in /google-play/listings, call " +
            "dataforseo#google-play/listings (the endpoint this list is " +
            "for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/app_data/google/app_listings/categories/",
        categories: ["app-stores"],
    },
    endpoint: "/google-play/listing-categories",
    request: {
        method: "GET",
