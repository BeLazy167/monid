...
/**
 * App Store Categories — `GET /v3/app_data/apple/categories` (v1
 * `/app-store/categories`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "App Store Categories",
        summary: "Look up App Store app category ids for chart requests.",
        description:
            "Free lookup. Returns the App Store category ids and names " +
            "used by app-store-app-list. Search matches the name. To use " +
            "these values in /app-store/app-list, call " +
            "dataforseo#app-store/app-list (the endpoint this list is " +
            "for).",
        docsUrl: "https://docs.dataforseo.com/v3/app_data/apple/categories/",
        categories: ["app-stores"],
    },
    endpoint: "/app-store/categories",
    request: { method: "GET", path: "/v3/app_data/apple/categories" },
