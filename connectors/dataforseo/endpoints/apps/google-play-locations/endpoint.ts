...
/**
 * Google Play Locations — `GET /v3/app_data/google/locations/{country}` (v1
 * `/google-play/locations`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Google Play Locations",
        summary: "Look up Google Play storefront location codes and names by " +
            "country and text.",
        description:
            ...
            "/google-play/search, call dataforseo#google-play/search (the " +
            "endpoint this list is for). To use these values in " +
            "/google-play/app-info, call dataforseo#google-play/app-info " +
            "(the endpoint this list is for). To use these values in " +
            "/google-play/app-reviews, call " +
            "dataforseo#google-play/app-reviews (the endpoint this list " +
            "is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/app_data/google/locations/{country}/",
        categories: ["app-stores"],
    },
    endpoint: "/google-play/locations",
    request: { method: "GET", path: "/v3/app_data/google/locations/{country}" },
    input: {
