...
export default defineEndpoint({
    meta: {
        ...
        summary: "Look up Google Play app category ids for chart requests.",
        description:
            "Free lookup. Returns the Google Play category ids and names " +
            "used by google-play-app-list. Search matches the name. To " +
