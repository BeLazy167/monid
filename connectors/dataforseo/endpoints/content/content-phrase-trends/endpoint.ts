...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "page_type, and filters. Suited for mention-volume trend " +
            "charts. To see which fields filters and order_by accept " +
            "here, call dataforseo#content/filters (free lookup of " +
            "filterable fields).",
        docsUrl:
