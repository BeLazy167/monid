...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "date_group, page_type, and filters. Suited for tracking " +
            "interest in a topic area. To see which fields filters and " +
            "order_by accept here, call dataforseo#content/filters (free " +
            "lookup of filterable fields). To find category codes for " +
            "content analysis, call dataforseo#content/categories (free " +
