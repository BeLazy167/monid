...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "top domains. Supports page_type and filters. Suited for a " +
            "quick share-of-voice snapshot. To see which fields filters " +
            "and order_by accept here, call dataforseo#content/filters " +
            "(free lookup of filterable fields).",
        docsUrl:
