...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "and filters. Suited for aggregate review sentiment of a " +
            "product or brand. To see which fields filters and order_by " +
            "accept here, call dataforseo#content/filters (free lookup of " +
            "filterable fields).",
        docsUrl:
