...
/**
 * Content Categories — `GET /v3/content_analysis/categories` (v1
 * `/content/categories`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Content Categories",
        summary: "Look up content analysis category codes by name.",
        description:
            "Free lookup. Returns rows of category_code, category_name, " +
            "and category_code_parent. Search matches the category name. " +
            "To use these values in /content/category-trends, call " +
            "dataforseo#content/category-trends (the endpoint this list " +
            "is for). To use these values in /content/search, call " +
            "dataforseo#content/search (the endpoint this list is for).",
        docsUrl: "https://docs.dataforseo.com/v3/content_analysis/categories/",
        categories: ["news-search"],
    },
    endpoint: "/content/categories",
    request: { method: "GET", path: "/v3/content_analysis/categories" },
