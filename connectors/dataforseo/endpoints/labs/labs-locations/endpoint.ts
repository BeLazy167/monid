...
/**
 * Labs Locations and Languages — `GET
 * /v3/dataforseo_labs/locations_and_languages` (v1 `/labs/locations`). Free
 * dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Labs Locations and Languages",
        summary: "Look up the country and language pairs the Labs keyword " +
            "endpoints support.",
        description:
            "Free lookup. Returns rows of location_code, location_name, " +
            "country_iso_code, and the available_languages " +
            "(language_name, language_code) for each. Search matches the " +
            "country name. To use these values in /labs/keyword-overview, " +
            "call dataforseo#labs/keyword-overview (the endpoint this " +
            "list is for). To use these values in /labs/ranked-keywords, " +
            "call dataforseo#labs/ranked-keywords (the endpoint this list " +
            "is for). To use these values in /labs/keywords-for-site, " +
            "call dataforseo#labs/keywords-for-site (the endpoint this " +
            "list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/dataforseo_labs/locations_and_languages/",
        categories: ["seo"],
    },
    endpoint: "/labs/locations",
    request: {
        method: "GET",
