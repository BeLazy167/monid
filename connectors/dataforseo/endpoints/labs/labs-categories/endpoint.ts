...
/**
 * Labs Categories — `GET /v3/dataforseo_labs/categories` (v1
 * `/labs/categories`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Labs Categories",
        summary: "Look up Google product and service category codes by name.",
        description:
            "Free lookup. Returns rows of category_code, category_name, " +
            "and category_code_parent for the Google product taxonomy. " +
            "Search matches the category name. To use these values in " +
            "/labs/keywords-for-categories, call " +
            "dataforseo#labs/keywords-for-categories (the endpoint this " +
            "list is for). To use these values in " +
            "/labs/categories-for-domain, call " +
            "dataforseo#labs/categories-for-domain (the endpoint this " +
            "list is for). To use these values in " +
            "/labs/domain-metrics-by-categories, call " +
            "dataforseo#labs/domain-metrics-by-categories (the endpoint " +
            "this list is for).",
        docsUrl: "https://docs.dataforseo.com/v3/dataforseo_labs/categories/",
        categories: ["seo"],
    },
    endpoint: "/labs/categories",
    request: { method: "GET", path: "/v3/dataforseo_labs/categories" },
